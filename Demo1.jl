...
Label(fig[1, 3],"Transformed development",fontsize = 20)
Label(fig[1, 4],"Lifted to sphere",fontsize = 20)
# ------------------------------------------------------------
# Axes
# ------------------------------------------------------------
ax_contact =Axis3(fig[2, 1])
ax_dev =Axis3(fig[2, 2])
ax_trans_dev =Axis3(fig[2, 3])
ax_holomorph =Axis3(fig[2, 4])


lines!(ax_contact,xs_contact,ys_contact,zs_contact,linewidth = 2)
lines!(ax_dev,xs_dev,ys_dev,zs_dev,linewidth = 2)

lines!(ax_trans_dev,trans_x,trans_y,trans_z,linewidth = 2)
lines!(ax_holomorph,holo_x,holo_y,holo_z,linewidth = 2)
lines!(ax_holomorph,circle_x,circle_y,circle_z,linewidth = 1)

# ============================================================
# Slider
# ============================================================

n_slider = Slider(fig[4, 2:3],range = 1:k,startvalue = 1)
...
scatter!(ax_dev,lift(n -> Point3f(xs_dev[n],ys_dev[n],zs_dev[n]),n_slider.value),color = :red,markersize = 15)
